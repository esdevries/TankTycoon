...
import 'package:app/util/calculations.dart';
              ...
              children: [
                Positioned.fill(
                  child: buildTileBackground(
                    colors: nationColors[currentNation]!,
                  ),
                ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Align(
                                    ...
                                    child: outlinedText(
                                      '${player.vehicleProgression[vehicle.name] ?? 0} in Battle',
                                      context,
                                      multiplier: 1.5,
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        outlinedText(
                                          'Cost: ${calculateCurrentPrice(vehicle.basePrice, player.vehicleProgression[vehicle.name] ?? 0)}Bp',
                                          context,
                                          multiplier: 1.5,
                                        ),
                                      ],
